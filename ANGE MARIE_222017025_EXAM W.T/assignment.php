...
<body bgcolor="brown">
  ...
  <ul style="list-style-type: none; padding: 0;">
    ...
    <img src="./Image/attachment.png" width="90" height="60" alt="Logo">
  </li>
...
<section id="home" style="display: block;">
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
      ...
      $stmt = $connection->prepare("INSERT INTO assignment (assignment_id, title, description, course_id, deadline) VALUES (?, ?, ?, ?, ?)");
      $stmt->bind_param("isssi", $assid, $tt, $desc, $cid, $dline);
...
<section>
  <center><h2>Table of Assignment</h2></center>
  <table border="5">
    <tr>
      <th>Assignment ID</th>
      <th>Title</th>
    ...
    // Prepare SQL query to retrieve all assignments
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                    ...
                    <td>" . $row['course_id'] . "</td>
                    <td>" . $row['deadline'] . "</td>
                    <td><a style='padding:4px' href='deleteAssignment.php?assignment_id=$assid'>Delete</a></td> 
                    <td><a style='padding:4px' href='updateAssignment.php?assignment_id=$assid'>Update</a></td> 
                  </tr>";
        }
    } else {
