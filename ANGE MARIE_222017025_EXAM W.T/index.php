...
<style>
  ...
  .btn-register {
    background-color: blackblue; /* Black */
    margin-left: 20px;
  }
...
<body style="background-image: url('./Images/E learn.jpeg');background-repeat: no-repeat;background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1 style="color: blue;">WELCOME TO OUR WEBSITE</h1>
    <p><i><b>our student our priority</b></i></p>
