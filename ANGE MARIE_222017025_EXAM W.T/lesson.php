...
<center>
  <section id="home" style="display: block;">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
        ...
        $stmt = $connection->prepare("INSERT INTO lesson (lesson_id, title, description, course_id) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("isss", $lid, $tt, $desc, $cid);
  ...
  <section>
    <center><h2>Table of Lessons</h2></center>
    <table border="5">
      <tr>
        <th>Lesson ID</th>
        <th>Title</th>
      ...
      // Prepare SQL query to retrieve all lessons
      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              echo "<tr>
                      ...
                      <td>" . $row['course_id'] . "</td>
                      <td><a style='padding:4px' href='deletelesson.php?lesson_id=$lid'>Delete</a></td> 
                      <td><a style='padding:4px' href='updatelesson.php?lesson_id=$lid'>Update</a></td> 
                    </tr>";
          }
      } else {
