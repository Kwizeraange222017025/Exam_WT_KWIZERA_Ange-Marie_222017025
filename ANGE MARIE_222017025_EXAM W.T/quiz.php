...
<center>
  <section id="home" style="display: block;">
    ...
    <form method="post" action="quiz.php">
      ...
      <input type="number" id="quiz_id" name="quiz_id"/><br><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
        ...
        $stmt = $connection->prepare("INSERT INTO quiz (quiz_id, title, description, course_id) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("isss", $qid, $tt, $desc, $cid);
  ...
  <section>
    ...
    <table border="5">
      ...
      // Prepare SQL query to retrieve all quizzes
      ...
      if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              echo "<tr>
                      ...
                      <td>" . $row['course_id'] . "</td>
                      <td><a style='padding:4px' href='deletequiz.php?quiz_id=$qid'>Delete</a></td> 
                      <td><a style='padding:4px' href='updatequiz.php?quiz_id=$qid'>Update</a></td> 
                    </tr>";
          }
      } else {
